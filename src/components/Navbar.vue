<template>
  <div class="navbar">
    <div class="row align-center">
      ...
      <q-img src="../assets/images/KYB portal.png" class="logo q-mr-sm" />
      <!-- <div class="navbar-heading">The KYB</div> -->
    </div>
    ...
    <div :class="{ 'navbar-items': true, show: menuOpen }">
      ...
      >
        <img
          src="../assets/icons/layout-dashboard.png"
          alt="User Icon"
          class="navbar-icon"
        />
      ...
      <div class="mobile-dropdown-container" v-show="isMobile">
        ...
        <div>
          <q-menu style="height: auto" v-model="dropdownOpen">
            <q-list>
              <!-- <q-item class="extra-mobile-logout" clickable v-close-popup>
                <q-icon
                  name="person"
                  class="avatar-icon menu-icon q-mr-sm"
                ></q-icon>
    ...
    <div class="dropdown-container">
      ...
      >
        <q-list>
          <!-- <q-item class="mobile-logout" clickable v-close-popup>
            <q-icon
              name="person"
              class="avatar-icon menu-icon q-mr-sm"
            ></q-icon>
